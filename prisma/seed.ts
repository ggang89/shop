  ...
  await prisma.product.createMany({
    data: [
      ...
      },
      {
        ...
        description:
          "전통 문화가 숨쉬는 거리에서 맛있는 길거리 음식을 즐기고, 전통 마사지로 몸과 마음을 힐링하세요.",
      },
      {
        ...
        description:
          "IT, 영화, 음악 산업의 고향, 현대 인류의 최첨단 유산이 성장한 곳에서 인류의 위대함을 느껴보세요. ",
      },
      {
      ...
      },
      {
        ...
        description:
          "자연의 웅장함과 귀여운 펭귄들을 만나볼 수 있는 특별한 여행지입니다. 일생일대의 경험과 자연의 경이로움을 느껴보세요",
      },
    ],
  });
