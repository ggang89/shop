  ...
  return (
    <div className="relative w-screen h-screen flex justify-center items-center">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${Products[id - 1].image.src})`,
        }}
      />
      ...
      <div className="relative z-10 flex gap-x-40">
        <Image
          ...
          alt={Products[id - 1].country}
          width={700}
          height={700}
        />
        <div className=" ">
          <h1 className="text-5xl font-bold mb-10"> {Products[id - 1].name}</h1>
          <h3 className="text-2xl font-bold italic text-gray-700 mb-3">
            {" "}
            {Products[id - 1].keyword}
          </h3>
          <p className="text-base/8">{Products[id - 1].description}</p>

          <div className="flex justify-self-end items-center p-5">
            <TicketsPlane /> &nbsp;
            <span className="text-end font-bold text-2xl">
              {Products[id - 1].price} 만원
            </span>
          </div>
